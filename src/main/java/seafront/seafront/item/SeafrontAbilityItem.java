...
public abstract class SeafrontAbilityItem extends SeafrontItem {

    protected String abilityName;
    protected List<String> abilityDescription;

    public SeafrontAbilityItem(String name, Material material, List<String> description, SeafrontRarity rarity, ItemType itemType, int sellPrice, String abilityName, List<String> abilityDescription) {
